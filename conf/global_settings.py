...
def parse_email_config(config: ConfigParser):
    try:
...
def parse_common_config(config: ConfigParser):
    try:
...
def parse_ocr_config(config: ConfigParser):
    try:
...
def parse_fund_config(config: ConfigParser):
    try:
...
def parse_stock_config(config: ConfigParser):
    try:
...
def parse_account_config(config: ConfigParser):
    try:
...
def parse_frog_server(config: ConfigParser):
    try:
...
def parse_backtest_config(config: ConfigParser):
    try:
