...
test_url = "http://fund.eastmoney.com/f10/F10DataApi.aspx?type=lsjz&code=000001&sdate=2001-12-18&edate=2020-05-18&per=20&page=1"  # noqa: E501
...
#     return [
#         f"https://{x['proxy']}"
#         for x in requests.get("http://127.0.0.1:5010/all?type=https").json()
#     ]
...
def get_http_proxies():
    ...
    for proxy in candidate_proxies:
        try:
            resp = requests.get(test_url, proxies={"http": proxy}, timeout=1)
