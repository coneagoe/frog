...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Filter stocks based on input and filter lists.")
    parser.add_argument("-i", required=True, help="Input CSV file containing list of stocks")
    parser.add_argument("-f", required=True, help="Filter CSV file containing list of stocks to exclude")
    parser.add_argument("-o", default="output.csv", help="Output CSV file (default: output.csv)")
