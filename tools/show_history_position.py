...
def show_stock_history_position(start_date: str, end_date: str, stock_ids: tuple):
    df_asset, df_profit, df_profit_rate = stock.load_history_positions(start_date, end_date, stock_ids)
...
def show_fund_history_position(start_date: str, end_date: str, fund_ids: tuple):
    df_asset, df_profit, df_profit_rate = fund.load_history_positions(start_date, end_date, fund_ids)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', type=str, nargs='*', default=None, help='security ids, default is None')
