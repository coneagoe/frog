"""Apply or roll back the Monitor PostgreSQL enum migration."""
...
from monitor.storage.enum_migration import (  # noqa: E402
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Migrate Monitor values to PostgreSQL enums", allow_abbrev=False)
...
def _print_result(result: MonitorEnumMigrationResult, *, json_output: bool) -> None:
    if json_output:
