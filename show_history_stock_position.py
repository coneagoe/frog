...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', type=str, default=None, help='stock id, default is None')
    ...
    df_asset, df_profit, df_profit_rate = load_history_positions(start_date, end_date, stock_id)
