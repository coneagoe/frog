...
class ETFBasic(Base):
    ...
    指数代码 = Column(COL_INDEX_CODE, String(20), nullable=True, comment="ETF基准指数代码")
    指数名称 = Column(COL_INDEX_NAME, String(40), nullable=True, comment="ETF基准指数中文全称")
