...
tb_name_history_data_daily_a_stock_bfq = "history_data_daily_a_stock_bfq"
...
class HistoryDataDailyAStockBFQ(Base):
    __tablename__ = tb_name_history_data_daily_a_stock_bfq
