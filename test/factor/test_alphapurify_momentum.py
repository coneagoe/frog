...
import factor.alphapurify_momentum as alphapurify_momentum  # noqa: E402
...
def test_main_loads_db_data_and_writes_ic_report(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(alphapurify_momentum, "FactorAnalyzer", FakeFactorAnalyzer)

    output_path = tmp_path / "momentum_ic.html"
    code = alphapurify_momentum.main(
        [
            "--start-date",
            "2024-01-01",
            "--end-date",
    ...
    assert captured["factor_name"] == "momentum"
