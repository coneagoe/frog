...
from trend_follow_300_pool import stocks  # noqa: E402

import conf  # noqa: E402
from stock import COL_STOCK_ID, drop_low_price_stocks, drop_st  # noqa: E402
...
if __name__ == "__main__":
    ...
    run(
        strategy_name="trend_follow_500_6",
        cerebro=cerebro,
        stocks=stocks,
