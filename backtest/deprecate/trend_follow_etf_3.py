...
from bt_common import run, show_position  # noqa: E402
...
class TrendFollowingStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.ema_low = {
            i: bt.indicators.EMA(self.datas[i].close, period=self.p.ema_period) for i in range(len(self.datas))
        }
        ...
        #                                      period_me1=self.p.p_macd_2_dif,
        #                                      period_me2=self.p.p_macd_2_dea,
        #                                      period_signal=self.p.p_macd_2_signal)
        #                                      for i in range(len(self.datas))}
