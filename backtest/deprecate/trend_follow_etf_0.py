...
class TrendFollowingStrategy(bt.Strategy):
    ...
    def stop(self):
        print(
            ...
            % (self.p.ema_period, self.p.num_positions, self.broker.getvalue())
        )
...
if __name__ == "__main__":
    ...
    run(
        strategy_name="trend_follow_etf_0",
        cerebro=cerebro,
        stocks=stocks,
...
if __name__ == "__main__":
    ...
    run(strategy_name='trend_follow_etf_0', cerebro=cerebro, stocks=stocks,
